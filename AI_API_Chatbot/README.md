...
![gemini cahtbot result](results/gemini.jpeg)
---
### 2. Cohere chatbot program 
![Cohere cahtbot result](results/cohere.png)
---
...
![huggingface chatbot result](results/huggingface.png)
---
### 6. Multiple API  chatbot program 
![multiple API query chatbot result](results/multiple%20api.png)
---
